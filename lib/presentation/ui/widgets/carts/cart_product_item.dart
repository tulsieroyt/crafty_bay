...
import 'package:crafty_bay/data/models/caragory/cart_item.dart';
...
class _CartProductItemState extends State<CartProductItem> {
  ...
  @override
  void initState() {
    log(widget.cartItem.quantity.toString());
    super.initState();
  }
              ...
              children: [
                Row(
                  children: [
                    ...
                    IconButton(
                      onPressed: () async {
                        final result = await Get.find<DeleteCartController>()
                            .deleteFromCart(widget.cartItem.productId!);
                        if (result) {
                          ...
                          SnackMessage.showMessage(
                            title: 'Failed',
                            message:
                                Get.find<DeleteCartController>().errorMessage,
                          );
                        }
                      },
                      icon: const Icon(
