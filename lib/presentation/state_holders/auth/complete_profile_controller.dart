...
class CompleteProfileController extends GetxController {
  ...
  CustomerData _profile = CustomerData();

  CustomerData get profile => _profile;

  Future<bool> createProfileData(
      String token, CreateProfileParams params) async {
    log('Create Profile data token is: $token');
    _inProgress = true;
    update();
    ...
    if (response.isSuccess) {
      _profile = CustomerData.fromJson(response.responseData['data']);
